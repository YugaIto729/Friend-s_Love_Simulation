...
public sealed class EventDecoder : MonoBehaviour
{
            ...
            //try
            {
                switch (eventText[0])
                {
                    ...
                    case "IMG_SET":
                        if (time == 5)
                        {
                            Decode_ImageSet(int.Parse(eventText[1]), int.Parse(eventText[2]), new Vector2(float.Parse(eventText[3]), float.Parse(eventText[4])), new Vector2(1, 1));
                        }
                        else if (time == 7)
                        {
                            Decode_ImageSet(int.Parse(eventText[1]), int.Parse(eventText[2]), new Vector2(float.Parse(eventText[3]), float.Parse(eventText[4])), new Vector2(float.Parse(eventText[5]), float.Parse(eventText[6])));
                    ...
                    case "BACKIMG_SET":
                        if (time == 7)
                        {
                            Decode_BackImg_Set(int.Parse(eventText[1]), int.Parse(eventText[2]), new Vector2(float.Parse(eventText[3]), float.Parse(eventText[4])), new Vector2(float.Parse(eventText[5]), float.Parse(eventText[6])));
                        }
                        else if (time == 5)
                        {
                            Decode_BackImg_Set(int.Parse(eventText[1]), int.Parse(eventText[2]), new Vector2(float.Parse(eventText[3]), float.Parse(eventText[4])), new Vector2(1, 1));
                        }
                        break;
                    case "BACKIMG_MOVE":
                        if (time == 6)
                    ...
                    case "BGMPLAY":
                        if (time == 3)
                        {
                            Decode_BGM_Play(int.Parse(eventText[1]), float.Parse(eventText[2]));
                        }
                        break;
                    case "BGMFADE":
                        if (time == 5)
                        {
                            ...
                            Decode_BGM_Fade(int.Parse(eventText[1]), float.Parse(eventText[2]), float.Parse(eventText[3]), mode);
                        }
                        break;
                    case "BGMVOL":
                        if (time == 3)
    ...
    private void Decode_BackImg_Set(int num, int num_sprite, Vector2 point, Vector2 size)
    {
        EventObject eventPage = new EventObject
        {
            eventType = EventType.BACK_SET,
            register2 = num,
            image_num = num_sprite,
            image_point = point,
            image_scale = size,
        };
    ...
    private void Decode_ImageSet(int num, int num_sp, Vector2 point, Vector2 size)
    {
        EventObject eventPage = new EventObject
        {
    ...
    private void Decode_BGM_Play(int num, float pitch)
    {
        EventObject eventPage = new EventObject
        {
    ...
    private void Decode_BGM_Fade(int num, float pitch, float seconds , int mode)
    {
        EventObject eventPage = new EventObject
        {
    ...
    private void Decode_SoundPlay(int num, float pitch, float volume)
    {
        EventObject eventPage = new EventObject
        {
